...
const PaymentPage = ({ history }) => {
  ...
  const [paymentMethod, setPaymentMethod] = useState("COD"); // default option is the stripe one, but users might not understand 'stripe'
          ...
          <Form.Group>
            <Col>
              ...
              <Form.Check
                inline
                type="radio"
                label="Chuyển khoản Momo/ Ngân Hàng"
                id="PayPal"
                name="paymentMethod"
                value="Bank"
